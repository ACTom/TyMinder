define(function(require, exports, module) {
    return module.exports = {
        ...
        'ui': {
            'langsavesuccess': 'Impostazione lingua salvata. Riavviare l\'applicazione per applicare le modifiche.',
            'untitledfilename': 'Mappa mentale senza titolo.km',
            'fileinfo': {
                ...
                'created': 'Creato',
                'modified': 'Modificato',
                'newfilehint': 'File non ancora salvato'
            },
            'undo': 'Annulla',
            'file': {
                'new': 'Nuovo',
                ...
                'export': 'Esporta',
                'import': 'Importa',
                'importdesc': 'Seleziona il formato file da importare',
                'exportdesc': 'Seleziona il formato file da esportare',
                'print': 'Stampa',
                'close': 'Chiudi',
            ...
            'about': {
                'version': 'Versione',
                'desc': 'Un semplice strumento di mappa mentale, basato su Tauri e KityMinder.',
                'copyright': 'Tutti i diritti riservati',
                'website': 'Pagina del progetto'
            },
            'command': {
            ...
            'dialog': {
                ...
                'unsaved': {
                    ...
                    'message': 'Ci sono modifiche non salvate. Vuoi salvarle?',
                    'save': 'Salva',
                ...
                'exportMarkdown': {
                    ...
                    'headingLevels': 'Livelli di intestazione',
                    'level': 'livello',
                    'levels': 'livelli',
                    'headingLevelsHint': 'I nodi oltre i livelli di intestazione useranno il formato elenco',
                    'rootNodeStyle': 'Stile nodo radice',
                    'rootAsDocTitle': 'Come titolo del documento (Consigliato)',
                    'rootAsHeading': 'Come intestazione normale',
                    'includeOptions': 'Includi',
                    'includeNote': 'Includi note',
                    'includeLink': 'Includi collegamenti',
                    'cancel': 'Cancella',
                    'export': 'Esporta'
                }
            },
