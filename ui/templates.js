angular.module('kityminderEditor').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui/directive/contextMenu/contextMenu.html',
    "<div class=\"km-context-menu\" ng-show=\"visible\" ng-style=\"{'left': menuX + 'px', 'top': menuY + 'px'}\"><ul class=\"menu-list\"><li ng-repeat=\"item in menuItems track by $index\" ng-class=\"{\r" +
    "\n" +
